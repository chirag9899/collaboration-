  ...
  async function delegate() {
    if (window.ethereum) {
      try {
        ...
        const contract = new web3.eth.Contract(DelegateRegistryABI.abi, contractAddress);
        ...
        try {
          ...
          const result = await contract.methods.setDelegate(id, delegateAddress).send({ from: delegator });
