...
export const chains = [
  ...
  { id: '0x13fb', chainName: 'citrea-testnet', name: 'Citrea Testnet', chainType: 'evm', blockExplorerUrl: 'https://explorer.testnet.citrea.xyz', rpc: 'https://rpc.testnet.citrea.xyz', nativeCurrency: { name: 'cBTC', symbol: 'cBTC', decimals: 18 } },
...
const walletToChains = {
  'metamask': ['ethereum', 'moonbeam', 'taiko', 'taiko-mainnet', 'linea', 'blast', 'merlin', 'berachain', 'moonriver', 'citrea-testnet'],
  'unisat': ['brc20', 'ordcollection', 'runes'],
  'xverse': ['brc20', 'ordcollection', 'runes'],
  'walletConnect': ['ethereum', 'moonbeam', 'taiko', 'taiko-mainnet', 'linea', 'blast', 'merlin', 'berachain', 'moonriver', 'citrea-testnet'],
}
