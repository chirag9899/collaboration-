...
const ListLoader = dynamic(() =>
  import("@/components/notification/listLoader"),
);
const List = dynamic(() => import("@/components/List"));

const Pagination = dynamic(() => import("@/components/pagination"));
const NotificationItem = dynamic(() =>
  import("../components/notification/notificationItem"),
);
const NotificationTabs = dynamic(() =>
  import("../components/notification/notificationTabs"),
);
